...
// ─── TYPES ───────────────────────────────────────────────────────────────────
interface User { id: number; name: string; handle: string; avatar: string; verified: boolean; bio: string; followers: string; following: string; posts: number }
interface Story { user: User; img: string; caption: string; time: string; seen: boolean }
interface Comment { user: User; text: string; time: string }
interface Post { id: number; user: User; time: string; location: string; img: string; caption: string; likes: number; badge: string | null; tags: string[]; music: string | null; comments: Comment[] }
interface Reel { id: number; user: User; img: string; views: string; music: string; likes: number; caption: string }

// ─── DATA ────────────────────────────────────────────────────────────────────
const ME: User = { id: 0, name: "You", handle: "kiwi.connect", avatar: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=200&q=80", verified: true, bio: "Full-service growth agency 🌿 17 years · 340+ brands scaled", followers: "12.4K", following: "891", posts: 340 };

const USERS: User[] = [
  { id: 1, name: "Priya Mehta",  handle: "priya.mehta",  avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80", verified: true,  bio: "CEO @ Lumē Skincare",     followers: "8.2K",  following: "312", posts: 127 },
  { id: 2, name: "Arjun Shetty", handle: "arjun.shetty", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80", verified: false, bio: "Founder @ Stackr Finance", followers: "5.6K",  following: "240", posts: 89  },
  { id: 3, name: "Kavita Rao",   handle: "kavita.rao",   avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&q=80", verified: true,  bio: "CMO @ NovaPulse",         followers: "11.1K", following: "198", posts: 214 },
  { id: 4, name: "Rohan Das",    handle: "rohan.das",    avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&q=80", verified: false, bio: "Marketing Lead",           followers: "3.4K",  following: "520", posts: 61  },
  { id: 5, name: "Sneha Pillai", handle: "sneha.pillai", avatar: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=100&q=80", verified: true,  bio: "Brand Strategist",         followers: "6.9K",  following: "310", posts: 98  },
];

const INITIAL_STORIES: Story[] = [
  { user: USERS[0], img: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=500&q=80", caption: "NovaPulse rebrand going live tomorrow! 🎉", time: "2h ago", seen: false },
  { user: USERS[2], img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=500&q=80", caption: "Q3 results in — 4.8× ROAS! 📈", time: "4h ago", seen: false },
  { user: USERS[4], img: "https://images.unsplash.com/photo-1551434678-e076c223a692?w=500&q=80", caption: "New blog on SEO trends 🔍", time: "6h ago", seen: true },
  { user: USERS[3], img: "https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=500&q=80", caption: "Stackr Finance MoM growth update 🚀", time: "8h ago", seen: false },
  { user: USERS[1], img: "https://images.unsplash.com/photo-1543286386-713bdd548da4?w=500&q=80", caption: "Monday energy 💪", time: "10h ago", seen: true },
];

const INITIAL_POSTS: Post[] = [
  { id: 1, user: USERS[0], time: "2h ago",  location: "Mumbai, India",    img: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=800&q=80", caption: "Excited to share our brand refresh for <b>NovaPulse</b>! Bold, fresh, and conversion-ready. 🚀 17 months of deep strategy work finally live.", likes: 2847, badge: "Brand Story",  tags: ["#BrandStrategy","#MarketingMagic"], music: "Brand New Day — Kiwi Mix",   comments: [{ user: USERS[1], text: "This looks absolutely stunning! 🔥", time: "1h ago" }, { user: USERS[2], text: "Incredible work ✨", time: "45m ago" }] },
  { id: 2, user: USERS[2], time: "5h ago",  location: "Bangalore, India", img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80", caption: "Our Q3 campaign delivered <b>4.8× ROAS</b> for Terrax Realty. The key? Never stop testing creatives. 💡", likes: 5214, badge: "Case Study",   tags: ["#PerformanceMarketing","#ROAS"], music: null, comments: [{ user: USERS[0], text: "Amazing results! 🙌", time: "3h ago" }] },
  { id: 3, user: USERS[4], time: "9h ago",  location: "Delhi, India",     img: "https://images.unsplash.com/photo-1551434678-e076c223a692?w=800&q=80", caption: "SEO isn't dead — it's evolving. Helped Lumē Skincare rank #1 on 60+ keywords with <b>zero paid spend</b>. 🔍", likes: 3961, badge: null, tags: ["#SEO","#ContentMarketing"], music: "Focus Mode — Lo-Fi Kiwi", comments: [] },
  { id: 4, user: USERS[1], time: "1d ago",  location: "Hyderabad, India", img: "https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=800&q=80", caption: "2.1× MoM growth for <b>Stackr Finance</b>. We owned every touchpoint — from cold scroll to warm conversion.", likes: 1783, badge: "Growth Story", tags: ["#FinTech","#DigitalMarketing"], music: null, comments: [] },
  { id: 5, user: USERS[3], time: "2d ago",  location: "Bhopal, India",    img: "https://images.unsplash.com/photo-1543286386-713bdd548da4?w=800&q=80", caption: "17 years. 340+ brands. Still obsessed with <b>measurable, compounding growth.</b> 🌿 Here's to the next 17.", likes: 8832, badge: "Milestone",    tags: ["#KiwiConnect","#17Years"], music: "Seventeen — Kiwi Anthem", comments: [{ user: USERS[0], text: "So proud! 💚", time: "1d ago" }] },
];

const REELS_DATA: Reel[] = [
  { id: 1, user: USERS[0], img: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&q=80",    views: "24.3K", music: "Growth Mindset Beat", likes: 1820, caption: "Behind the scenes of our NovaPulse brand shoot 🎥" },
  { id: 2, user: USERS[2], img: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=400&q=80", views: "18.7K", music: "Data Driven",          likes: 934,  caption: "How we achieved 4.8× ROAS in 30 days 📈" },
  { id: 3, user: USERS[4], img: "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=400&q=80",    views: "41.2K", music: "SEO Lofi",             likes: 2640, caption: "SEO secrets that tripled our client's traffic 🔍" },
  { id: 4, user: USERS[1], img: "https://images.unsplash.com/photo-1543286386-713bdd548da4?w=400&q=80",    views: "9.8K",  music: "Kiwi Vibes",          likes: 710,  caption: "17 years of growth. One agency. ✦" },
  { id: 5, user: USERS[3], img: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=400&q=80", views: "33.1K", music: "Campaign Mode",        likes: 1950, caption: "Full team creative day at Kiwi HQ 🌿" },
  { id: 6, user: USERS[0], img: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=400&q=80", views: "15.6K", music: "Brand Energy",         likes: 880,  caption: "Client strategy session — the energy was 🔥" },
];
...
const INITIAL_NOTIFS = [
  { icon: "❤️", text: "<b>priya.mehta</b> liked your post", time: "2m ago", unread: true },
  { icon: "💬", text: "<b>arjun.shetty</b> commented: <i>'Incredible work!'</i>", time: "15m ago", unread: true },
  { icon: "👥", text: "<b>sneha.pillai</b> started following you", time: "1h ago", unread: true },
  { icon: "🔖", text: "<b>rohan.das</b> saved your post", time: "3h ago", unread: false },
  { icon: "🏷️", text: "<b>kavita.rao</b> mentioned you", time: "5h ago", unread: false },
];
...
// ─── CSS VARS ─────────────────────────────────────────────────────────────────
const V = {
  pink: "#ff6ce7", purple: "#ba3aff", dark: "#1A1A1A",
  sand: "#F2F0EA", cream: "#FAFAF7", white: "#fff", border: "#EAE6E0", muted: "#888",
};
    ...
    <div onClick={(e) => { if (e.target === e.currentTarget) onClose(); }} style={{ position: "fixed", inset: 0, background: "rgba(10,10,10,.92)", zIndex: 999, display: "flex", alignItems: "center", justifyContent: "center", backdropFilter: "blur(8px)" }}>
      <div style={{ width: 360, maxWidth: "94vw", background: V.dark, borderRadius: 24, overflow: "hidden", boxShadow: "0 32px 80px rgba(0,0,0,.6)", position: "relative" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px" }}>
          ...
          <button onClick={onClose} style={{ background: "none", border: "none", color: "rgba(255,255,255,.7)", fontSize: 20, cursor: "pointer", borderRadius: "50%", width: 30, height: 30, display: "flex", alignItems: "center", justifyContent: "center" }}>✕</button>
        </div>
...
// ─── POST CARD ────────────────────────────────────────────────────────────────
function PostCard({ post, liked, saved, reaction, showCm, followed, onLike, onSave, onFollow, onReact, onComment, onToggleCm }: {
  post: Post; liked: boolean; saved: boolean; reaction: string | null; showCm: boolean; followed: boolean;
  onLike: () => void; onSave: () => void; onFollow: () => void; onReact: (e: string) => void; onComment: (t: string) => void; onToggleCm: () => void;
}) {
  ...
  return (
    <div style={{ background: V.white, border: `1px solid ${V.border}`, borderRadius: 20, marginBottom: 18, overflow: "hidden", boxShadow: "0 2px 20px rgba(0,0,0,.04)", animation: "slideUp .5s both" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "13px 15px" }}>
        <img src={post.user.avatar} alt="" style={{ width: 40, height: 40, borderRadius: "50%", objectFit: "cover", border: `2px solid ${V.pink}`, flexShrink: 0 }} onError={(e) => { (e.target as HTMLImageElement).style.opacity = ".3"; }} />
        <div style={{ flex: 1 }}>
          <div style={{ fontWeight: 700, fontSize: 13.5, display: "flex", alignItems: "center", gap: 4 }}>{post.user.name}{post.user.verified && <Verified />}</div>
      ...
      <div onDoubleClick={doubleTap} onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)} style={{ position: "relative", overflow: "hidden", cursor: "pointer" }}>
        ...
        {post.badge && <div style={{ position: "absolute", top: 12, right: 12, background: grad, color: "#fff", fontSize: 10, fontWeight: 800, padding: "4px 12px", borderRadius: 100, letterSpacing: ".5px", textTransform: "uppercase", boxShadow: "0 4px 12px rgba(255,108,231,.4)" }}>{post.badge}</div>}
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 2, padding: "10px 12px 6px", position: "relative" }}>
        {reactOpen && (
          <div onMouseLeave={() => setReactOpen(false)} style={{ position: "absolute", bottom: 44, left: 4, background: V.white, border: `1px solid ${V.border}`, borderRadius: 100, padding: "6px 10px", boxShadow: "0 8px 32px rgba(0,0,0,.12)", display: "flex", gap: 4, zIndex: 50 }}>
            {REACTIONS.map(e => <span key={e} onClick={() => { onReact(e); setReactOpen(false); }} style={{ fontSize: 22, cursor: "pointer", padding: "2px 4px", borderRadius: "50%", display: "inline-block", transition: "transform .15s" }} onMouseEnter={el => (el.target as HTMLElement).style.transform = "scale(1.3)"} onMouseLeave={el => (el.target as HTMLElement).style.transform = ""}>{e}</span>)}
          </div>
        )}
        {[
      ...
      {post.comments.length > 0 && (
        <>
          <div onClick={onToggleCm} style={{ padding: "0 15px 4px", fontSize: 13, color: V.muted, cursor: "pointer" }}>{showCm ? "Hide" : `View all ${post.comments.length}`} comment{post.comments.length > 1 ? "s" : ""}</div>
          {showCm && (
              ...
              {post.comments.map((c, i) => (
                <div key={i} style={{ display: "flex", gap: 8, alignItems: "flex-start", marginBottom: 8 }}>
                  ...
                  <div style={{ background: V.sand, borderRadius: "0 12px 12px 12px", padding: "6px 10px", fontSize: 12.5, lineHeight: 1.5, flex: 1 }}>
                    <div style={{ fontWeight: 700, fontSize: 12, marginBottom: 1 }}>{c.user.name}</div>
                    {c.text}
                    <div style={{ display: "flex", gap: 10, marginTop: 4 }}>
                      <button style={{ background: "none", border: "none", fontSize: 11, color: V.muted, cursor: "pointer", padding: 0, fontFamily: "'DM Sans',sans-serif" }}>Like</button>
                      <button style={{ background: "none", border: "none", fontSize: 11, color: V.muted, cursor: "pointer", padding: 0, fontFamily: "'DM Sans',sans-serif" }}>Reply</button>
      ...
      {/* Comment input */}
      <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 14px 12px", borderTop: `1px solid ${V.border}` }}>
        <img src={ME.avatar} alt="" style={{ width: 30, height: 30, borderRadius: "50%", objectFit: "cover", flexShrink: 0 }} />
        <div style={{ flex: 1, background: V.sand, border: `1.5px solid ${commentText ? V.pink : "transparent"}`, borderRadius: 100, display: "flex", alignItems: "center", padding: "0 12px", transition: "all .25s", boxShadow: commentText ? "0 0 0 3px rgba(255,108,231,.1)" : "none" }}>
          <input value={commentText} onChange={e => setCommentText(e.target.value)} onKeyDown={e => { if (e.key === "Enter" && commentText.trim()) { onComment(commentText.trim()); setCommentText(""); } }} placeholder="Add a comment…" style={{ flex: 1, background: "none", border: "none", outline: "none", fontSize: 13, fontFamily: "'DM Sans',sans-serif", color: V.dark, padding: "8px 0" }} />
          <button style={{ background: "none", border: "none", cursor: "pointer", fontSize: 16 }}>😊</button>
          {commentText.trim() && <button onClick={() => { onComment(commentText.trim()); setCommentText(""); }} style={{ background: "none", border: "none", cursor: "pointer", fontSize: 13, fontWeight: 700, color: V.pink, padding: "0 4px" }}>Post</button>}
        </div>
      </div>
    </div>
  );
...
function ReelCard({ reel, liked, onLike }: { reel: Reel; liked: boolean; onLike: () => void }) {
  ...
  return (
    <div style={{ position: "relative", borderRadius: 20, overflow: "hidden", background: V.dark, aspectRatio: "9/16", maxHeight: 580, boxShadow: "0 8px 40px rgba(0,0,0,.18)", animation: "slideUp .5s both", flexShrink: 0, width: "100%" }}>
      ...
      {/* Play button */}
      <div style={{ position: "absolute", top: "40%", left: "50%", transform: "translate(-50%,-50%)", width: 54, height: 54, background: grad, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, color: "#fff", boxShadow: "0 4px 20px rgba(255,108,231,.5)", cursor: "pointer" }}>▶</div>
      {/* Right actions */}
      <div style={{ position: "absolute", right: 14, bottom: 100, display: "flex", flexDirection: "column", gap: 20, alignItems: "center" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
          ...
          <span style={{ fontSize: 11, fontWeight: 700, color: "#fff" }}>142</span>
        </div>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
      ...
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 60, padding: "0 14px 16px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
          ...
          <button style={{ marginLeft: "auto", background: "none", border: `1.5px solid ${V.pink}`, color: V.pink, fontSize: 12, fontWeight: 700, padding: "4px 12px", borderRadius: 100, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" }}>Follow</button>
        </div>
...
function PostPage({ onPost }: { onPost: (text: string, img: string) => void }) {
  ...
  function handlePost() {
    ...
    setText(""); setSelectedImg(null); setStep("compose");
  ...
  return (
    <div style={{ maxWidth: 520, margin: "0 auto", padding: "0 0 24px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 16px 16px" }}>
        ...
        <button onClick={handlePost} disabled={!text.trim()} style={{ background: text.trim() ? grad : V.border, border: "none", borderRadius: 100, padding: "10px 24px", fontSize: 14, fontWeight: 700, color: text.trim() ? "#fff" : V.muted, cursor: text.trim() ? "pointer" : "not-allowed", fontFamily: "'DM Sans',sans-serif", boxShadow: text.trim() ? "0 4px 16px rgba(255,108,231,.35)" : "none", transition: "all .25s" }}>Share →</button>
      </div>

      {/* Composer body */}
      <div style={{ background: V.white, borderRadius: 20, margin: "0 16px", border: `1px solid ${V.border}`, boxShadow: "0 2px 20px rgba(0,0,0,.04)", overflow: "hidden" }}>
        <div style={{ display: "flex", gap: 12, padding: "16px 16px 12px", alignItems: "flex-start" }}>
          <img src={ME.avatar} alt="" style={{ width: 44, height: 44, borderRadius: "50%", objectFit: "cover", border: `2.5px solid ${V.pink}`, flexShrink: 0 }} />
          <div style={{ flex: 1 }}>
            <div style={{ fontWeight: 700, fontSize: 14, marginBottom: 2, display: "flex", alignItems: "center", gap: 4 }}>{ME.name} <Verified /></div>
      ...
      <div style={{ margin: "16px 16px 0", background: V.white, border: `1px solid ${V.border}`, borderRadius: 16, padding: "12px 14px" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
          {["#BrandStrategy","#ROAS","#GrowthMarketing","#SEO","#KiwiConnect","#DigitalIndia"].map(t => (
            <span key={t} onClick={() => setText(prev => prev + " " + t)} style={{ fontSize: 12, fontWeight: 700, color: V.pink, background: "rgba(255,108,231,.08)", padding: "4px 12px", borderRadius: 100, cursor: "pointer", transition: "background .2s" }} onMouseEnter={e => (e.currentTarget.style.background = "rgba(255,108,231,.18)")} onMouseLeave={e => (e.currentTarget.style.background = "rgba(255,108,231,.08)")}>{t}</span>
          ))}
        </div>
      </div>
    </div>
...
function ProfilePage({ postImages }: { postImages: string[] }) {
  ...
  const tabs = [{ key: "posts", icon: "⊞", label: "Posts" }, { key: "reels", icon: "▶", label: "Reels" }, { key: "saved", icon: "🔖", label: "Saved" }] as const;
  ...
  return (
    <div style={{ maxWidth: 520, margin: "0 auto", paddingBottom: 24 }}>
      ...
      <div style={{ position: "relative", height: 140, background: `linear-gradient(135deg,${V.pink}22,${V.purple}22)`, borderRadius: "0 0 24px 24px", overflow: "hidden" }}>
        ...
        {/* Bubble blobs */}
        {[{ w: 200, h: 200, bg: V.pink, t: "-60px", l: "-40px" }, { w: 160, h: 160, bg: V.purple, t: "20px", r: "-20px" }].map((b, i) => (
          <div key={i} style={{ position: "absolute", width: b.w, height: b.h, background: b.bg, borderRadius: "50%", filter: "blur(60px)", opacity: .25, top: b.t, left: (b as any).l, right: (b as any).r }} />
        ))}
      </div>
      ...
      <div style={{ padding: "0 20px", marginTop: -44 }}>
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 12 }}>
          <div style={{ position: "relative" }}>
            <img src={ME.avatar} alt="" style={{ width: 88, height: 88, borderRadius: "50%", objectFit: "cover", border: `4px solid ${V.white}`, boxShadow: "0 4px 20px rgba(0,0,0,.12)" }} />
            <div style={{ position: "absolute", bottom: 2, right: 2, width: 22, height: 22, background: grad, borderRadius: "50%", border: `2px solid ${V.white}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "#fff" }}>✓</div>
          </div>
          <button onClick={() => setEditOpen(!editOpen)} style={{ background: V.white, border: `1.5px solid ${V.border}`, borderRadius: 100, padding: "8px 18px", fontSize: 13, fontWeight: 700, color: V.dark, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", transition: "all .2s", boxShadow: "0 2px 12px rgba(0,0,0,.06)" }} onMouseEnter={e => { (e.currentTarget.style.borderColor = V.pink); (e.currentTarget.style.color = V.pink); }} onMouseLeave={e => { (e.currentTarget.style.borderColor = V.border); (e.currentTarget.style.color = V.dark); }}>Edit Profile</button>
        </div>

        {/* Name & bio */}
        <div style={{ fontFamily: "'Syne',sans-serif", fontSize: 20, fontWeight: 900, display: "flex", alignItems: "center", gap: 6, marginBottom: 3 }}>{ME.name} <Verified /></div>
        <div style={{ fontSize: 13, color: V.muted, marginBottom: 8 }}>@{ME.handle}</div>
        <div style={{ fontSize: 14, color: V.dark, lineHeight: 1.6, marginBottom: 14 }}>{bio}</div>

        {/* Stats row */}
        <div style={{ display: "flex", gap: 0, background: V.white, border: `1px solid ${V.border}`, borderRadius: 16, overflow: "hidden", marginBottom: 16, boxShadow: "0 2px 12px rgba(0,0,0,.04)" }}>
          {[[String(ME.posts), "Posts"], [ME.followers, "Followers"], [ME.following, "Following"]].map(([val, lbl], i) => (
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 20 }}>
          <button style={{ flex: 1, background: grad, border: "none", borderRadius: 100, padding: "11px", fontSize: 13, fontWeight: 700, color: "#fff", cursor: "pointer", fontFamily: "'DM Sans',sans-serif", boxShadow: "0 4px 16px rgba(255,108,231,.35)" }}>✦ Share Profile</button>
          <button style={{ flex: 1, background: V.white, border: `1.5px solid ${V.border}`, borderRadius: 100, padding: "11px", fontSize: 13, fontWeight: 700, color: V.dark, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" }}>Insights →</button>
        </div>

        {/* Edit bio panel */}
        {editOpen && (
          <div style={{ background: V.white, border: `1px solid ${V.border}`, borderRadius: 16, padding: 16, marginBottom: 16, boxShadow: "0 4px 24px rgba(0,0,0,.08)", animation: "slideUp .3s both" }}>
            <div style={{ fontFamily: "'Syne',sans-serif", fontSize: 14, fontWeight: 800, marginBottom: 10 }}>Edit Bio</div>
            <textarea value={bio} onChange={e => setBio(e.target.value)} rows={3} style={{ width: "100%", background: V.sand, border: `1.5px solid ${V.pink}`, borderRadius: 12, padding: "10px 14px", fontFamily: "'DM Sans',sans-serif", fontSize: 13.5, color: V.dark, outline: "none", resize: "none", boxShadow: "0 0 0 3px rgba(255,108,231,.1)" }} />
            <button onClick={() => setEditOpen(false)} style={{ marginTop: 10, background: grad, border: "none", borderRadius: 100, padding: "9px 22px", fontSize: 13, fontWeight: 700, color: "#fff", cursor: "pointer", fontFamily: "'DM Sans',sans-serif", boxShadow: "0 4px 16px rgba(255,108,231,.35)" }}>Save Changes</button>
          </div>
        )}
        ...
        {activeProfileTab === "posts" && (
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 3, borderRadius: 16, overflow: "hidden" }}>
            {postImages.map((src, i) => (
              <div key={i} style={{ aspectRatio: "1", overflow: "hidden", cursor: "pointer", position: "relative" }}>
                <img src={src} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", transition: "transform .3s" }} onMouseEnter={e => (e.target as HTMLImageElement).style.transform = "scale(1.07)"} onMouseLeave={e => (e.target as HTMLImageElement).style.transform = ""} onError={(e) => { (e.target as HTMLImageElement).style.opacity = ".3"; }} />
              </div>
            ))}
          </div>
        )}
        ...
        {activeProfileTab === "saved" && (
          <div style={{ textAlign: "center", padding: "48px 20px", color: V.muted }}>
            ...
            <div style={{ fontFamily: "'Syne',sans-serif", fontSize: 17, fontWeight: 800, color: V.dark }}>Saved posts appear here</div>
            <div style={{ fontSize: 13, marginTop: 6 }}>Tap 🏷️ on any post in the feed to save it</div>
          </div>
        )}
      </div>
    </div>
...
export default function KiwiGram() {
  ...
  const filteredUsers = searchQuery ? USERS.filter(u => u.name.toLowerCase().includes(searchQuery.toLowerCase()) || u.handle.toLowerCase().includes(searchQuery.toLowerCase())) : USERS;

  function toggleLike(id: number) { setLikes(p => ({ ...p, [id]: !p[id] })); }
  function toggleSave(id: number) { setSaved(p => ({ ...p, [id]: !p[id] })); }
  function setReaction(id: number, e: string) { setReactions(p => ({ ...p, [id]: e })); setLikes(p => ({ ...p, [id]: true })); }
  function toggleFollow(id: number) { setFollowed(p => ({ ...p, [id]: !p[id] })); }
  function toggleShowCm(id: number) { setShowCm(p => ({ ...p, [id]: !p[id] })); }
  function addComment(postId: number, text: string) {
    setPosts(p => p.map(post => post.id === postId ? { ...post, comments: [...post.comments, { user: ME, text, time: "Just now" }] } : post));
    setShowCm(p => ({ ...p, [postId]: true }));
  }
  function handleNewPost(text: string, img: string) {
    const np: Post = { id: Date.now(), user: ME, time: "Just now", location: "Bhopal, India", img, caption: text, likes: 0, badge: null, tags: [], music: null, comments: [] };
    setPosts(p => [np, ...p]);
    setActiveTab("home");
  }
  ...
  const EXPLORE_IMGS = [
    { src: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=400&q=80", likes: "2.8K", tall: true },
    { src: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400&q=80", likes: "5.2K", tall: false },
    { src: "https://images.unsplash.com/photo-1551434678-e076c223a692?w=400&q=80", likes: "4.0K", tall: false },
    { src: "https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=400&q=80", likes: "1.8K", tall: false },
    { src: "https://images.unsplash.com/photo-1543286386-713bdd548da4?w=400&q=80", likes: "8.8K", tall: true },
    { src: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&q=80", likes: "3.1K", tall: false },
    { src: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=400&q=80", likes: "2.2K", tall: false },
    { src: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=400&q=80", likes: "6.7K", tall: false },
  ];
    ...
    <>
      ...
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", zIndex: 0, overflow: "hidden" }}>
        {[{ w:500,h:500,bg:V.pink,top:"-100px",left:"-100px",d:"0s" },{ w:400,h:400,bg:V.purple,top:"20%",right:"-80px",d:"-4s" },{ w:350,h:350,bg:"#6DBF3E",bottom:"10%",left:"10%",d:"-8s" },{ w:300,h:300,bg:V.pink,bottom:"-80px",right:"20%",d:"-6s" }].map((b,i)=>(
          <div key={i} style={{ position:"absolute", borderRadius:"50%", filter:"blur(80px)", opacity:.18, animation:`bFloat 12s ease-in-out ${b.d} infinite`, width:b.w, height:b.h, background:b.bg, top:(b as any).top, left:(b as any).left, bottom:(b as any).bottom, right:(b as any).right }} />
        ))}
      </div>

      {/* Story viewer */}
      {storyIdx !== null && <StoryViewer stories={stories} index={storyIdx} onClose={() => setStoryIdx(null)} onNext={() => { storyIdx < stories.length - 1 ? setStoryIdx(storyIdx + 1) : setStoryIdx(null); }} onPrev={() => { if (storyIdx > 0) setStoryIdx(storyIdx - 1); }} />}
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 300, background: "rgba(250,250,247,.92)", backdropFilter: "blur(16px)", borderBottom: `1px solid ${V.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 20px", height: 56, gap: 10 }}>
        <div style={{ fontFamily: "'Syne',sans-serif", fontSize: 20, fontWeight: 900, background: grad, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", cursor: "pointer", flexShrink: 0, display: "flex", alignItems: "center", gap: 6 }} onClick={() => setActiveTab("home")}>
          ...
          {searchOpen && filteredUsers.length > 0 && (
            <div style={{ position: "absolute", top: "calc(100% + 6px)", left: 0, right: 0, background: V.white, border: `1px solid ${V.border}`, borderRadius: 16, boxShadow: "0 8px 32px rgba(0,0,0,.1)", zIndex: 400, overflow: "hidden" }}>
              {filteredUsers.slice(0, 5).map(u => (
                <div key={u.id} onClick={() => { setSearchQuery("@" + u.handle); setSearchOpen(false); }} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", cursor: "pointer", transition: "background .2s" }} onMouseEnter={e => (e.currentTarget.style.background = V.sand)} onMouseLeave={e => (e.currentTarget.style.background = "")}>
          ...
          <div ref={notifRef} style={{ position: "relative" }}>
            ...
            {notifOpen && (
              <div style={{ position:"absolute",top:"calc(100% + 8px)",right:0,background:V.white,border:`1px solid ${V.border}`,borderRadius:20,width:310,boxShadow:"0 12px 48px rgba(0,0,0,.12)",zIndex:400,overflow:"hidden" }}>
                ...
                {notifs.map((n,i) => (
                  <div key={i} style={{ display:"flex",gap:10,alignItems:"flex-start",padding:"10px 16px",borderBottom:i<notifs.length-1?`1px solid ${V.border}`:"none",background:n.unread?"rgba(255,108,231,.04)":"transparent",cursor:"pointer",transition:"background .2s" }}>
        ...
        <div style={{ flex:1, minWidth:0, maxWidth:630, margin:"0 auto" }}>
                ...
                <div style={{ display:"flex", gap:12, width:"max-content" }}>
                  ...
                  {stories.map((s,i) => (
                    <div key={i} onClick={() => { setStoryIdx(i); setStories(ss=>ss.map((x,xi)=>xi===i?{...x,seen:true}:x)); }} style={{ display:"flex",flexDirection:"column",alignItems:"center",gap:5,cursor:"pointer" }}>
                      <div style={{ width:62,height:62,borderRadius:"50%",padding:2.5,background:s.seen?"linear-gradient(135deg,#ddd,#ccc)":grad,transition:"transform .2s,box-shadow .2s" }} onMouseEnter={e=>{(e.currentTarget.style.transform="scale(1.06)");(e.currentTarget.style.boxShadow="0 4px 20px rgba(255,108,231,.4)")}} onMouseLeave={e=>{(e.currentTarget.style.transform="");(e.currentTarget.style.boxShadow="")}}>
              ...
              {posts.map((p,i) => (
                <div key={p.id} style={{ animation:`slideUp .5s ${i*0.06}s both` }}>
                  <PostCard post={p} liked={!!likes[p.id]} saved={!!saved[p.id]} reaction={reactions[p.id]||null} showCm={!!showCm[p.id]} followed={!!followed[p.user.id]}
                    onLike={() => toggleLike(p.id)} onSave={() => toggleSave(p.id)} onFollow={() => toggleFollow(p.user.id)}
          ...
          {activeTab === "explore" && (
            <div>
              ...
              <div style={{ marginTop:24, background:V.white, border:`1px solid ${V.border}`, borderRadius:20, padding:18, boxShadow:"0 2px 16px rgba(0,0,0,.04)" }}>
                ...
                {TRENDING.map((t,i) => (
                  <div key={i} style={{ padding:"8px 0",borderBottom:i<TRENDING.length-1?`1px solid ${V.border}`:"none",cursor:"pointer",display:"flex",justifyContent:"space-between",alignItems:"center" }}>
                    <div>
                      <div style={{ fontSize:13,fontWeight:700,color:V.pink }}>{t.tag}</div>
                      <div style={{ fontSize:11,color:V.muted,marginTop:1 }}>{t.posts} posts</div>
                    </div>
          ...
          {activeTab === "reels" && (
            <div>
              ...
              <div style={{ display:"flex",flexDirection:"column",gap:16 }}>
                {REELS_DATA.map((r,i) => (
                  <div key={r.id} style={{ animation:`slideUp .4s ${i*0.08}s both` }}>
                    <ReelCard reel={r} liked={!!reelLikes[r.id]} onLike={() => setReelLikes(p=>({...p,[r.id]:!p[r.id]}))} />
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="kg-sidebar" style={{ width:290,flexShrink:0,display:"none",flexDirection:"column",gap:16 }}>
          ...
          <div style={{ background:V.white,border:`1px solid ${V.border}`,borderRadius:20,padding:18,boxShadow:"0 2px 16px rgba(0,0,0,.04)" }}>
            <div style={{ display:"flex",alignItems:"center",gap:12,marginBottom:16 }}>
              <img src={ME.avatar} alt="" style={{ width:54,height:54,borderRadius:"50%",objectFit:"cover",border:`2.5px solid ${V.pink}`,flexShrink:0 }} />
              <div>
                <div style={{ fontFamily:"'Syne',sans-serif",fontWeight:800,fontSize:15,display:"flex",alignItems:"center",gap:4 }}>{ME.name} <Verified /></div>
                <div style={{ fontSize:12,color:V.muted,marginTop:2 }}>@{ME.handle}</div>
              </div>
              <span onClick={() => setActiveTab("profile")} style={{ marginLeft:"auto",fontSize:11.5,fontWeight:700,color:V.pink,cursor:"pointer" }}>View →</span>
            </div>
          ...
          <div style={{ background:V.white,border:`1px solid ${V.border}`,borderRadius:20,padding:18,boxShadow:"0 2px 16px rgba(0,0,0,.04)" }}>
            ...
            {SUGGESTIONS.map(u => (
              <div key={u.id} style={{ display:"flex",alignItems:"center",gap:10,marginBottom:12 }}>
                ...
                <button onClick={() => setSuggFollowed(p=>({...p,[u.id]:!p[u.id]}))} style={{ background:suggFollowed[u.id]?grad:"none", border:`1.5px solid ${suggFollowed[u.id]?"transparent":V.pink}`, color:suggFollowed[u.id]?"#fff":V.pink, fontSize:11.5, fontWeight:700, padding:"5px 12px", borderRadius:100, cursor:"pointer", fontFamily:"'DM Sans',sans-serif", transition:"all .2s", whiteSpace:"nowrap" }}>
